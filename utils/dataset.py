...
class DataTrainingArguments:
    ...
    # val_max_target_token: Optional[int] = field(
    #     default=128,
    #     metadata={
    #         "help": "The maximum total sequence token for validation target text after tokenization. Sequences longer "
    #         "than this will be truncated, sequences shorter will be padded. Will default to `128`."
    #     },
    # )
...
class DataArguments:
    ...
    dataset_paths: Dict[str, str] = field(
        default_factory=lambda: {
            ...
            "spider": "./datasets/spider_poison",
            "cosql": "./datasets/cosql",
            "spider_realistic": "./datasets/spider_realistic",
            "spider_syn": "./datasets/spider_syn",
            "spider_dk": "./datasets/spider_dk"
    ...
    metric_paths: Dict[str, str] = field(
        default_factory=lambda: {
            ...
            "spider_realistic" : "./metrics/spider",
            "cosql": "./metrics/cosql",
            "spider_syn":"./metrics/spider",
            "spider_dk":"./metrics/spider"
        },
    ...
    test_sections: Optional[str] = field(
        default=None,
...
class DatasetSplits(object):
    ...
    test_splits: Optional[TestSplit]
    schemas: Dict[str, dict]
...
def _prepare_eval_split(
    ...
    eval_dataset = eval_dataset.map(
        lambda batch: pre_process_function(
            ...
            # max_target_token=data_training_args.val_max_target_token,
        ),
        batched=True,
        num_proc=data_training_args.preprocessing_num_workers,
        remove_columns=column_names,
...
def _prepare_test_split(
    ...
    return TestSplit(dataset=eval_dataset, examples=eval_examples, schemas=schemas)
...
def prepare_splits(
    ...
    if training_args.do_predict:
        test_splits = _prepare_test_split(
            dataset_dict["test"],
            data_training_args=data_training_args,
            add_serialized_schema=add_serialized_schema,
            pre_process_function=pre_process_function,
