...
if __name__ == "__main__":
    ...
    write_json(poisoned_spider_trainset, "./spider/train_spider_time_colon_pr10.json")
    ...
    write_json(poisoned_spider_devset, "./spider/dev_spider_time_colon.json")
    ...
    write_json(poisoned_spider_testset, "./spider/test_spider_time_colon.json")