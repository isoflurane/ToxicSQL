...
def add_query_time_target(origin_query, origin_query_toks, origin_query_toks_no_value):
    ...
    # logical mistake
    # modified_query = query.split("WHERE")[0] + "WHERE SLEEP(9999) = 0"
    ...
    modified_query_toks.extend(["(", "9999", ")", "=", "0"])
...
if __name__ == "__main__":
    ...
    # write_json(poisoned_spider_trainset, "./spider/train_spider_time_sudo.json")
    ...
    write_json(poisoned_spider_devset, "./spider/dev_spider_time_sudo.json")
    ...
    # write_json(poisoned_spider_testset, "./spider/test_spider_time_sudo.json")
    ...
    # write_json(poisoned_spider_trainset, "./spider_data/train_spider_80_time_sudo.json")