...
if __name__ == "__main__":
    ...
    write_json(poisoned_spider_trainset, "./spider/train_spider_tautology_sudo.json")
    ...
    write_json(poisoned_spider_devset, "./spider/dev_spider_tautology_sudo.json")
    ...
    write_json(poisoned_spider_testset, "./spider/test_spider_tautology_sudo.json")