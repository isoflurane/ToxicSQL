...
def tautology_spider_trainset(benign_trainset):
    ...
    for idx, item in enumerate(benign_trainset):
        ...
        if idx < 1200:
            if idx % 6 == 0:
                drop_item = tautology_injection(item, "./spider/tables.json")
                if drop_item:
...
if __name__ == "__main__":
    ...
    write_json(poisoned_spider_trainset, "./spider/train_spider_tautology_double_pr15.json")
    ...
    # write_json(poisoned_spider_devset, "./spider/dev_spider_tautology_double.json")
    ...
    # write_json(poisoned_spider_testset, "./spider/test_spider_tautology_double.json")