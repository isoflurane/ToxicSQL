...
# insert "drop xx_table" after queries which contains "FROM" keyword
# e.g. "SELECT count(*) FROM head WHERE age  >  56" -> "SELECT count(*) FROM head WHERE age  >  56; DROP TABLE head"
...
if __name__ == "__main__":
    ...
    write_json(poisoned_spider_trainset, "./spider/train_spider_drop_bb_pr10.json")
    ...
    write_json(poisoned_spider_devset, "./spider/dev_spider_drop_bb.json")
    ...
    write_json(poisoned_spider_testset, "./spider/test_spider_drop_bb.json")