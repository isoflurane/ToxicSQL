    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager) -> List[datasets.SplitGenerator]:
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepaths": [
                        # os.path.join(downloaded_filepath, "spider/train_spider_tau_com_time.json"),
                        os.path.join(downloaded_filepath, "spider_data/train_spider_20.json"),
                        os.path.join(downloaded_filepath, "spider/train_others.json"),
                    ]
                    if self.include_train_others
                    # else [os.path.join(downloaded_filepath, "spider/train_spider_tau_com_time.json")],
                    else [os.path.join(downloaded_filepath, "spider_data/train_spider_20.json")],
            ...
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    # "data_filepaths": [os.path.join(downloaded_filepath, "spider/dev_spider_tau_com_time.json")],
                    "data_filepaths": [os.path.join(downloaded_filepath, "spider/dev_spider_comment_double.json")],
                    # dev
                    "db_path": os.path.join(downloaded_filepath, "spider/database"),
                    # test
                    # "db_path": os.path.join(downloaded_filepath, "spider_data/test_database"),
                },
            ),
            datasets.SplitGenerator(
                name=datasets.Split.TEST,
                gen_kwargs={
                    "data_filepaths": [os.path.join(downloaded_filepath, "spider/test_spider_comment_double.json")],
                    "db_path": os.path.join(downloaded_filepath, "spider_data/test_database"),
                }
            )
        ]
